...
public class netList {
    ...
    public Circuit readingFile(String  S) {
        ...
        for(int i=0;circuit.getNode()[i]!=null;i++)
        {
            for (int j=0;j<circuit.getNode()[i].getAttachments().size();j++)
            {
                if (circuit.getNode()[i].getAttachments().get(j).getNode1()==circuit.getNode()[i])
                ...
                if (circuit.getNode()[i].getAttachments().get(j).getNode2()==circuit.getNode()[i])
