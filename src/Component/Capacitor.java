 ...
 */
    ...
    public void setCurrent(double dt,double dv,double di) {
     /*   CircuitAnalysis.setNodeVoltagederive(node1.getnumber(),time);
        ...
        current+=(capacity*((node1.getVoltage()-node2.getVoltage_p())-(node1.getVoltage_p()-node2.getVoltage_p())))/dt;
    }
    ...
    public void setCurrent_p(double dt,double dv,double di) {
        current+=(capacity*((node1.getVoltage()-node2.getVoltage_p())-(node1.getVoltage_p()-node2.getVoltage_p())+dv))/dt;
    }
